package webview.sangjinj.fileupload03;

import android.app.Activity;
import android.os.Bundle;
import java.io.File;
import java.util.ArrayList;
import webview.sangjinj.fileupload03.ra;
import android.app.Activity;
...
public class fileupload03Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fileupload03);
    ...
    private class DoFindImageList extends AsyncTask<String, Integer, Long> {
        ...
        protected void onPreExecute() {
            mLoagindDialog = ProgressDialog.show(fileupload03Activity.this, null, "로딩중...", true, true);
            super.onPreExecute();
        }
